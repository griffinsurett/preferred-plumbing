        ...
        >
          {hasUrl ? (
            <a
              ...
              className="text-2xl font-bold leading-tight py-2 text-center tracking-[0.08em] text-on-primary hover:text-accent transition-colors"
            >
              {title}
            </a>
          ) : (
  ...
  return (
    <li>
      <a
        ...
        target={openInNewTab ? "_blank" : undefined}
        rel={openInNewTab ? "noopener noreferrer" : undefined}
        className={`text-2xl font-bold leading-tight mx-auto block max-w-sm py-2 px-4 text-center tracking-[0.08em] text-on-primary hover:text-accent rounded-md transition-colors ${nestedSpacingClass}`}
      >
        {title}
      </a>
    </li>
